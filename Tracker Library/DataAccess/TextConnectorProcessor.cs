...
namespace Tracker_Library.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        public static void SaveToTournamentFile(this List<TournamentModel> models)
        {
            ...
            {
                lines.Add($"{ tm.Id },{ tm.TournamentName },{ tm.EntryFee },{ ConvertTeamListToString(tm.EnteredTeams) },{ConvertPrizeListToString(tm.Prizes)},{ConvertRoundListString(tm.Rounds)}");
            }
        ...
        public static void SaveToRoundFile(this TournamentModel model)
        {
        ...
        private static string ConvertRoundListString(List<List<MatchupModel>> rounds)
        {
            ...
            {
                output += $"{ConvertMatchupListString(r)}|";
            }
            output = output.Substring(0, output.Length - 1);

            return output;
        }
        private static string ConvertMatchupListString(List<MatchupModel> matchups)
        {
            string output = "";
